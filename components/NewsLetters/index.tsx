...
const NewsLatterBox = () => {
  ...
  return (
    <div className="container my-10">
      <div
        className="wow fadeInUp relative z-10 rounded-lg bg-white p-4 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11"
        data-wow-delay=".2s"
      >
        <h3 className="mb-10 border-b border-body-color border-opacity-25 pb-5 text-2xl font-bold leading-tight text-black dark:border-white dark:border-opacity-25 dark:text-white">
          Zarejestruj się, aby otrzymywać informacje o naszych promocjach
        </h3>
        ...
        <div className="flex w-full flex-col md:flex-row">
          <div className="flex w-full flex-col md:flex-row md:gap-4 ">
            <input
              ...
              className="mb-5 w-full rounded-lg border border-stroke bg-[#f8f8f8] px-6 py-2 text-base text-body-color outline-none focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:text-body-color-dark dark:shadow-two dark:focus:border-primary dark:focus:shadow-none"
            />
            <input
              type="email"
              name="email"
          ...
          <div className="flex max-w-md flex-col md:ml-4">
            <input
              type="submit"
              value="Subscribe"
              className="mb-5 flex w-full cursor-pointer items-center justify-center rounded-lg bg-primary px-9 py-3 text-base font-medium text-white shadow-submit duration-300 hover:bg-primary/90 dark:shadow-submit-dark"
            />
            {/* <p className="text-center text-base leading-relaxed text-body-color dark:text-body-color-dark">
              Brak spamu gwarantowany, więc prosimy o niewysyłanie spamu.
            </p> */}
          </div>
        </div>
