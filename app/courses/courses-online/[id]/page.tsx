import coursesDataOn from "@/components/Courses/coursesDataOn";
...
export default function Details({ params }: { params: { id: string } }) {
  const course = coursesDataOn.find((post) => post.id === Number(params.id));
  return (
    <>
                ...
                <div>
                  ...
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-center text-base font-medium italic text-body-color">
                      ...
                      Instytucji Szkoleniowych pod numerem: 2.02/00166/2021, na
                      podstawie ustawy o promocji zatrudnienia i instytucjach
                      rynku pracy. Działalność oświatową prowadzimy na zasadach
                      określonych w przepisach ustawy Prawo przedsiębiorców.
                      Działalność ta nie stanowi prowadzenia szkoły, placówki,
                      zespołu, o którym mowa w art. 182 ustawy Prawo oświatowe,
